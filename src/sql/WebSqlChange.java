...
public class WebSqlChange {
    ...
    public String dbDisplaySave(){
        ...
        String displayDetail=request.getParameter("displayDetail");
        /*存入school信息*/
        String itemID=item.getItemID();
        String schoolID=(String)session.get("schoolID");
        String schoolName=request.getParameter("name");
        String schoolKind=request.getParameter("kind");
        ...
        schoolHandler.setSchoolProvince(schoolLocation);
        schoolHandler.setSchoolName(schoolName);
        schoolHandler.insert();
        JSONObject displayDetailJSON=JSONObject.fromObject(displayDetail);
        ItemHandler itemHandler=new ItemHandler();
        itemHandler.saveItem(itemID,order,displayDetailJSON);
        Map map= new HashMap();
        map.put("result","success");
